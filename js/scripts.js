...
! function(u) {
    ...
    $('.button-see').on('click', function() {
        ...
        let contentHtml = '<img src="'+ _this.data("src") +'">\
            ...
            ';
        if (instagram) {
            contentHtml += '<li><a href="'+ instagram +'" target="_blank"><i class="fab fa-instagram-square"></i></a></li>';
        }

        if (phone) {
            contentHtml += '<li><a href="'+ phone +'" target="_blank"><i class="fa fa-phone-square"></i></a></li>';
        }

        if (facebook) {
            contentHtml += '<li><a href="'+ facebook +'" target="_blank"><i class="fab fa-facebook-square"></i></a></li>';
        }
